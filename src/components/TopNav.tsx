      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-8">
        <nav className="flex items-center justify-between gap-3">
          <div className="logo">
            ...
            >
              <svg width="44" height="44" viewBox="0 0 44 44" style={{ overflow: "visible" }}>
                <circle cx="22" cy="22" r="21" fill="rgba(233,174,183,0.18)" stroke="rgba(233,174,183,0.35)" strokeWidth="1" />
                <text
                  x="22"
                  y="26"
                  textAnchor="middle"
          ...
          <div className="flex items-center gap-6 text-sm font-semibold">
            <Link href="/product?c=vit" className="hover:opacity-90" style={{color:'var(--accent-2)'}}>
              Shop
            </Link>
            <a className="hidden sm:inline hover:opacity-90" href="#info" style={{color:'var(--muted)'}}>
              Info
            </a>
