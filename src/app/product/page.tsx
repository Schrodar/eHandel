...
export default function ProductPage() {
  ...
  function selectColor(col: string) {
    ...
    // Vit knapp är till vänster, svart till höger
    // När vi väljer vit: vit kommer från vänster, svart går ut åt höger
    // När vi väljer svart: svart kommer från höger, vit går ut åt vänster
    if (col === 'vit') {
      setDirection('left'); // vit in från vänster, svart ut åt höger
    } else {
      setDirection('right'); // svart in från höger, vit ut åt vänster
    }
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-black/60">
                      Heavyweight cotton • Matte finish
                    </p>
                  </div>
                ...
                <div className="mt-6 divide-y divide-black/10 rounded-2xl border border-black/10 bg-white/60">
                  <details className="group px-4 py-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-black/70">
                      Minimalist tee with a premium hand-feel. Built for
                      everyday wear.
                    </p>
                  </details>
